...
import com.mydiary.diary.diarywithlock.secretdiary.personaldiary.easynote.privatejournal.dailydiary.fragments.FragmentSplash.Companion.key
                    ...
                    if (task.isSuccessful) {
                        ...
                        if (BuildConfig.DEBUG) {
                            SharedPref.putString(
                                AppConstans.bannerId1,
                                context.getString(R.string.admob_banner_id1)
                            )
                            SharedPref.putString(
                                AppConstans.bannerId2,
                                context.getString(R.string.admob_banner_id2)
                            )
                            SharedPref.putString(
                                AppConstans.bannerId3,
                                context.getString(R.string.admob_banner_id3)
                            )
                            SharedPref.putString(
                                AppConstans.bannerId4,
                                context.getString(R.string.admob_banner_id4)
                            )
                            SharedPref.putString(
                                AppConstans.bannerId5,
                                context.getString(R.string.admob_banner_id5)
                            )
                            SharedPref.putString(
                                AppConstans.nativeId1,
                                context.getString(R.string.admob_native_id1)
                            )

                            SharedPref.putString(
                                AppConstans.nativeId2,
                                context.getString(R.string.admob_native_id2)
                            )
                            SharedPref.putString(
                                AppConstans.nativeId3,
                                context.getString(R.string.admob_native_id3)
                            )
                            SharedPref.putString(
                                AppConstans.nativeId4,
                                context.getString(R.string.admob_native_id4)
                            )
                            SharedPref.putString(
                                AppConstans.nativeId5,
                                context.getString(R.string.admob_native_id5)
                            )
                            SharedPref.putString(
                                AppConstans.intersitialId1,
                                context.getString(R.string.admob_intersitial_id1)
                            )

                            SharedPref.putString(
                                AppConstans.intersitialId2,
                                context.getString(R.string.admob_intersitial_id2)
                            )
                            SharedPref.putString(
                                AppConstans.intersitialId3,
                                context.getString(R.string.admob_intersitial_id3)
                            )
                            SharedPref.putString(
                                AppConstans.intersitialId4,
                                context.getString(R.string.admob_intersitial_id4)
                            )
                            SharedPref.putString(
                                AppConstans.intersitialId5,
                                context.getString(R.string.admob_intersitial_id5)
                            )
                            ...
                            SharedPref.putString(
                                AppConstans.bannerId1,
                                remoteConfig.getString(AppConstans.bannerId1)
                            )
                            SharedPref.putString(
                                AppConstans.bannerId2,
                                remoteConfig.getString(AppConstans.bannerId2)
                            )
                            SharedPref.putString(
                                AppConstans.bannerId3,
                                remoteConfig.getString(AppConstans.bannerId3)
                            )
                            SharedPref.putString(
                                AppConstans.bannerId4,
                                remoteConfig.getString(AppConstans.bannerId4)
                            )
                            SharedPref.putString(
                                AppConstans.bannerId5,
                                remoteConfig.getString(AppConstans.bannerId5)
                            )

                            SharedPref.putString(
                                AppConstans.nativeId1,
                                remoteConfig.getString(AppConstans.nativeId1)
                            )
                            SharedPref.putString(
                                AppConstans.nativeId2,
                                remoteConfig.getString(AppConstans.nativeId2)
                            )
                            SharedPref.putString(
                                AppConstans.nativeId3,
                                remoteConfig.getString(AppConstans.nativeId3)
                            )
                            SharedPref.putString(
                                AppConstans.nativeId4,
                                remoteConfig.getString(AppConstans.nativeId4)
                            )
                            SharedPref.putString(
                                AppConstans.nativeId5,
                                remoteConfig.getString(AppConstans.nativeId5)
                            )

                            SharedPref.putString(
                                AppConstans.intersitialId1,
                                remoteConfig.getString(AppConstans.intersitialId1)
                            )
                            SharedPref.putString(
                                AppConstans.intersitialId2,
                                remoteConfig.getString(AppConstans.intersitialId2)
                            )
                            SharedPref.putString(
                                AppConstans.intersitialId3,
                                remoteConfig.getString(AppConstans.intersitialId3)
                            )
                            SharedPref.putString(
                                AppConstans.intersitialId4,
                                remoteConfig.getString(AppConstans.intersitialId4)
                            )
                            SharedPref.putString(
                                AppConstans.intersitialId5,
                                remoteConfig.getString(AppConstans.intersitialId5)
                            )
                        }
                        ...
                        SharedPref.putInt(
                            AppConstans.BatchScan,
                            getValue(remoteConfig.getString(AppConstans.BatchScan))
                        )
                        SharedPref.putString(
                            AppConstans.UXCam,
                            remoteConfig.getString(AppConstans.UXCam)
                        )
                        getAdmobCtaColors(remoteConfig.getString(AppConstans.Applovin_layoutTemplate))
                        SharedPref.putInt(
                            AppConstans.CappingCounter,
                            getValue(remoteConfig.getString(AppConstans.CappingCounter))
                        )
                        SharedPref.putInt(
                            AppConstans.nativeRequests,
                            getValue(remoteConfig.getString(AppConstans.nativeRequests))
                        )
                        SharedPref.putInt(
                            AppConstans.bannerRequests,
                            getValue(remoteConfig.getString(AppConstans.bannerRequests))
                        )
                        SharedPref.putInt(
                            AppConstans.interstitialRequests,
                            getValue(remoteConfig.getString(AppConstans.interstitialRequests))
                        )
//                        setValue(context)
